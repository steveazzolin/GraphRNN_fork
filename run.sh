...
#SBATCH -t 2-00:00
#SBATCH --output=/home/steve.azzolin/GraphRNN_fork/sbatch_outputs/planar_batch32.txt
#SBATCH --error=/home/steve.azzolin/GraphRNN_fork/sbatch_outputs/planar_batch32.txt
#SBATCH --ntasks=1
#SBATCH -N 1
